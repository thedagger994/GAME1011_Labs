...
int main()
{
	...
	cout << "prefix postfix test\n";
	Vector2 v5{ 1.0f, 2.0f };
	Vector2 postfix = v5++;
	postfix.printVector(); //prefix = v5 before the ++
	Vector2 prefix = --postfix;
	prefix.printVector(); //-- is applied first, then assigned to prefix
